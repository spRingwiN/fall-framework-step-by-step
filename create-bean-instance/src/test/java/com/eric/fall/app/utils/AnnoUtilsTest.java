...
import com.eric.instance.annotation.Order;
import com.eric.instance.exception.BeanDefinitionException;
import com.eric.instance.utils.ClassUtils;
...
public class AnnoUtilsTest {
    ...
    public void simpleConfiguration() throws Exception {
        assertNotNull(ClassUtils.findAnnotation(SimpleConfiguration.class, Configuration.class));
    ...
    public void simpleConfigurationWithName() throws Exception {
        assertNotNull(ClassUtils.findAnnotation(SimpleConfigurationWithName.class, Configuration.class));
