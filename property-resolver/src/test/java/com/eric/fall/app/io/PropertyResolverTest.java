...
import com.eric.property.io.PropertyResolver;
...
public class PropertyResolverTest {
    ...
    public void propertyValue() {
        ...
        props.setProperty("app.title", "Fall Framework");
        props.setProperty("app.version", "v1.0");
        props.setProperty("jdbc.url", "jdbc:mysql://local:3306/simpsons");
        ...
        assertEquals("Fall Framework", pr.getProperty("app.title"));
        ...
        assertEquals("Eric Sun", pr.getProperty("app.author", "Eric Sun"));
    ...
    public void requiredProperty() {
        ...
        var pr = new PropertyResolver(props);
        assertThrows(NullPointerException.class, () -> pr.getRequiredProperty("app.author"));
    }
